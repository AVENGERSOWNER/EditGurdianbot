...
from config import LOGGER, MONGO_URI, DB_NAME, BOT_TOKEN, OWNER_ID, SUDO_ID, BOT_NAME, SUPPORT_ID, API_ID, API_HASH

app = Client("AutoDelete", bot_token=BOT_TOKEN, api_id=API_ID, api_hash=API_HASH)
